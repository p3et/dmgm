...
import org.biiig.dmgm.impl.operators.fsm.CharacteristicGeneralizedSubgraphs;
import org.biiig.dmgm.impl.operators.subgraph_mining.common.SubgraphMiningThresholdTestBase;

public class GCSMThresholdTest extends SubgraphMiningThresholdTestBase {

  @Override
  protected CollectionToCollectionOperator getOperator(PropertyGraphDB db, boolean b, float minSupportRel, int maxEdgeCount) {
    return new CharacteristicGeneralizedSubgraphs(db, TestConstants.PARALLEL, minSupportRel, maxEdgeCount);
  }
}