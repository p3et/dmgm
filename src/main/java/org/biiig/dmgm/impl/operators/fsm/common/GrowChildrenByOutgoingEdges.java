...
public class GrowChildrenByOutgoingEdges<G extends WithCachedGraph, E extends WithEmbedding>
  extends GrowChildrenBase<G, E> {

  public GrowChildrenByOutgoingEdges(DFSCode parent, BiFunction<G, DFSEmbedding, E> embeddingFactory) {
    super(parent, embeddingFactory);
  }
