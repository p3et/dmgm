...
public interface SubgraphMiningVariantMethods<G extends WithGraph, S> {
  /**
   ...
   */
  long[] output(
    List<Pair<DFSCode, S>> frequentPatterns, Map<DFSCode, List<WithDFSEmbedding>> patternEmbeddings, Map<Long, G> graphIndex, S minSupportAbsolute);
}
