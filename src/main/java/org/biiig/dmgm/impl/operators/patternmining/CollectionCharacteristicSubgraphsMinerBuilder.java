...
public class CollectionCharacteristicSubgraphsMinerBuilder extends WithDatabaseAccessBase {
   ...
   */
  CollectionCharacteristicSubgraphsMinerBuilder(PropertyGraphDb database, boolean parallel) {
