...
public abstract class CharacteristicSubgraphsBase<G extends WithGraphAndCategory, E extends WithEmbeddingAndCategory>
  extends SubgraphMiningBase<G, E, Map<Integer, Long>> implements CharacteristicSupportMethods {
   ...
   */
  protected final int defaultCategory;

  public CharacteristicSubgraphsBase(PropertyGraphDB db, boolean parallel, float minSupportRel, int maxEdgeCount) {
