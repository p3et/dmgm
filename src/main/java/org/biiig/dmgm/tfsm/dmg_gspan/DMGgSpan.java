...
import org.biiig.dmgm.tfsm.dmg_gspan.gspan.GSpanTreeNode;
 ...
 */
public class DMGgSpan extends GSpanBase {
  ...
  public DMGgSpan(String inputPath, Float minSupportThreshold, int kMax) {
